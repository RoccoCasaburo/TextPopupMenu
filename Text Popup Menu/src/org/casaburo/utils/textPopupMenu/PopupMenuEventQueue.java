 ...
 * PopupMenuEventQueue());
 * <p>
 * Utilizzo: viene abilitato in automatico aggiungendo la seguente riga di
 * codice: Toolkit.getDefaultToolkit().getSystemEventQueue().push(new
 * PopupMenuEventQueue());
 *
 */
...
//      selectAllString = KeyEvent.getKeyText(KeyEvent.VK_ALL_CANDIDATES);
        ...
        selectAllString = bundle.getString("SelectAllString");
    }
    ...
    protected void dispatchEvent(AWTEvent event) {
        ...
        Component component;
        try {
            component = SwingUtilities.getDeepestComponentAt((Component) me.getSource(), me.getX(), me.getY());
            ...
            Logger.getLogger("TextPopupMenu").log(Level.FINE, ex.getLocalizedMessage());
        }
